...
class BodyProductos extends StatefulWidget {
  BodyProductos({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _BodyProductosPageState createState() => _BodyProductosPageState();
}

class _BodyProductosPageState extends State<BodyProductos> {
